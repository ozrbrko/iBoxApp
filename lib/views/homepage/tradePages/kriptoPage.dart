...
import '../../../viewmodel/kripto_view_model.dart';

class KriptoPage extends StatefulWidget {
  const KriptoPage({Key? key}) : super(key: key);
...
class _KriptoPageState extends State<KriptoPage> {
  KriptoViewModel? kriptoStore;

  @override
  void initState() {
    kriptoStore = KriptoViewModel();
    kriptoStore!.init();
    kriptoStore!.getKriptoDatas();
    super.initState();
  }
            ...
            child: Container(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final item = kriptoStore!.kriptoResultList![index];
                      return Column(
                        children: [
                          Padding(
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Center(
                                                child: Text(
                                                  "Fiyat", style: TextStyle(
                                                  fontSize: 15, fontWeight: FontWeight.w500,
                                                  fontFamily: 'IBMPlexSans',),)),
                                            Text(item.pricestr.toString(),style: TextStyle(
                                                fontSize: 13, fontWeight: FontWeight.normal,
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Center(
                                              child: Text(
                                                "Değişim",style: TextStyle(
                                                fontSize: 15, fontWeight: FontWeight.w500,
                                                fontFamily: 'IBMPlexSans',),),),
                                            Text(item.changeHourstr!
